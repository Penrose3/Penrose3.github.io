...
<?php
  ...
  if (isset($_GET['id']) && isset($_GET['date']) && isset($_GET['name']) && isset($_GET['score']) && isset($_GET['ext']) && isset($_GET['screenshot'])) {
  ...
  else if (isset($_POST['id']) && isset($_POST['name']) && isset($_POST['score']) && isset($_POST['ext'])) {
  ...
  if (isset($_POST['submit'])) {
    if ($_POST['confirm'] == 'Yes') {
      ...
      $query = "DELETE FROM wk6_guitarwars WHERE id = $id LIMIT 1";
    ...
    echo '<p><strong>Name: </strong>' . $name . '<br /><strong>Date: </strong>' . $date .
      '<br /><strong>Score: </strong>' . $score . '<br /><strong>File extension: </strong>' . $file_ext . '</p>';
    ...
    echo '<input type="hidden" name="ext" value="' . $file_ext . '" />';
    echo '</form>';
  }
