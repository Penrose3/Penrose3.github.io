...
if ($_SESSION['usertype'] == 1) {
       ...
       if (!empty($new_picture)) {
         ...
         $query = "UPDATE wk8mismatch_user SET first_name = '$first_name', last_name = '$last_name', gender = '$gender', " .

           " birthdate = '$birthdate', city = '$city', state = '$state', picture = '$new_picture' WHERE user_id = '" . $_POST['user_id'] . "'";
         ...
         $query = "UPDATE wk8mismatch_user SET first_name = '$first_name', last_name = '$last_name', gender = '$gender', " .
           ...
           " birthdate = '$birthdate', city = '$city', state = '$state' WHERE user_id = '" . $_POST['user_id'] . "'";
    ...
    if ($_SESSION['usertype'] == 1) {
        ...
        $query = "SELECT first_name, last_name, gender, birthdate, city, state, picture FROM wk8mismatch_user WHERE user_id = '" . $_GET['user_id'] . "'";

     }

     else{

        $query = "SELECT first_name, last_name, gender, birthdate, city, state, picture FROM wk8mismatch_user WHERE user_id = '" . $_SESSION['user_id'] . "'";
