...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2015 at 08:26 PM
...
--
-- Table structure for table `aliens_abduction_wk3`
--

CREATE TABLE IF NOT EXISTS `aliens_abduction_wk3` (
...
--
-- Dumping data for table `aliens_abduction_wk3`
--

INSERT INTO `aliens_abduction_wk3` (`first_name`, `last_name`, `when_it_happened`, `how_long`, `how_many`, `alien_description`, `what_they_did`, `fang_spotted`, `other`, `email`) VALUES
...
('', '', '0000-00-00', '', '', '', '', '', '', ''),
('', '', '0000-00-00', '', '', '', '', 'yes', '', ''),
('joe', 'dude', '2015-09-09', '2 weeks', 'test', 'test', 'test', 'yes', 'test', 'dude@dude.com');
